    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alt_text', models.CharField(blank=True, help_text='대체 텍스트. 비워두면 캡션 또는 파일명에서 채워집니다.', max_length=255)),
                ('ai_generated_alt', models.BooleanField(default=False, help_text='Gemini가 자동 생성한 alt 텍스트인지 표시')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='blog_images.customimage')),
            ],
            options={
